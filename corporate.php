...
<head>
    ...
    <title>Corporate Events | Enchanted Events</title>
    <style>
        body{
...
<br><br><br>
    <div class="container1">
    <img class="im" src="conference.jpg" alt="">
    <div class="container2">
...
<div class="container1">
    <img class="im" src="party.jpg" alt="">
    <div class="container2">
        <h2>Theme Party</h2>
